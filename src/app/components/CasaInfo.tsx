...
export default function CasaInfo({ casa }: Readonly<{ casa: Casa }>) {
    return (
        <div className="grid grid-cols-3 grid-flow-row w-full flex-wrap text-center items-center gap-7">
            ...
            <div className="flex flex-col align-middle text-center items-center">
                <Tooltip color="primary" showArrow content="Número de Cajones de Estacionamiento" placement="top" className="font-bold">
                    <img src="/estacionamiento.svg" alt="Estacionamiento" className="h-10 mt-2 md:h-14 w-fit" />
                </Tooltip>
            ...
            <div className="flex flex-col align-middle text-center items-center pr-2">
                <Chip size="lg" className="w-fit uppercase text-default-700" variant="light" >
